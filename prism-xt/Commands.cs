...
namespace PrismProject
{
    public class Cmds
    {
        ...
        {
            AddCommand("print", "print - Print any string of text, used for console applications.", print);
            AddCommand("about", "about - About prism OS", about);
            AddCommand("help", "help - List all available commands", help);
            AddCommand("shutdown", "shutdown - Shuts down the system.\nArguments\n==========\nnone      regular shutdown\n-r    restarts the system instead", shutdown);
            AddCommand("systime", "systime - prints the system time", systime);
            AddCommand("clear", "clear - clear entire console", clear);
            AddCommand("jingle", "jingle - plays the boot chime", jingle);
            AddCommand("sysinfo", "sysinfo - Prints system information", sysinfo);
            AddCommand("tone", "Tone - used to make sounds in an app", tone);
        }

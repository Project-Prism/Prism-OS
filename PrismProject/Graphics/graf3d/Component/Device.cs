                ...
                foreach (var face in mesh.Faces)
                {
                    ...
                    face.Edges((a, b) =>
                    {
                        ...
                        if (ClippingAlgorithm.ClipLine(ref p1, ref p2))
                        {
                            ...
                            LineDrawingAlgorithm.DrawLine(p1, p2, (x, y) => PrismProject.Functions.Graphics.Canvas2.Canvas.DrawPoint(new Cosmos.System.Graphics.Pen(System.Drawing.Color.FromArgb(color32.A, color32.R, color32.G, color32.B)), x, y));
                        }
                    });
                }
            }

...
namespace PrismProject.Services
{
    class Resource_Service
    {
        ...
        [ManifestResourceStream(ResourceName = "PrismProject.Files.Fonts.CaviarDreams_Bold.b64")] static readonly byte[] CaviarDreams_bold;
        ...
        public static PCScreenFont CaviarDream_Bold_Font => PCScreenFont.LoadFont(FromBase64String(ASCII.GetString(CaviarDreams_bold)));
    }
}

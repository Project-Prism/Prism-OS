...
using static PrismOS.Core.Hexi.Misc.Function;
using PrismOS.Core.Hexi.Misc;

namespace PrismOS.Core.Hexi
{
							...
							if (func.Name == function)
							{
								...
								for (var j = 0; j < func.Arguments; j++)
								{
									...
									else if (arg.StartsWith("b[") && arg.EndsWith("]"))
									{
										...
										Functions[i] = new Hexi.Misc.Function(func.Name, func.Type, func.Arguments + count, func.Definition);
									}
									else
									{

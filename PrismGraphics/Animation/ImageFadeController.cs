namespace PrismGraphics.Animation
{
	...
	/// </summary>
	public class ImageFadeController
	{
		/// <summary>
		/// Creates a new instance of the <see cref="ImageFadeController"/> class.
		/// </summary>
		...
		public ImageFadeController(Graphics Image, float Source, float Target, TimeSpan Duration, AnimationMode Mode)
		{

namespace PrismGraphics.Animation
{
	...
	{
		/// <summary>
		/// Creates a new instance of the <see cref="FadeController"/> class.
		/// </summary>
		...
		public FadeController(Graphics Image, float Source, float Target, TimeSpan Duration, AnimationMode Mode)
		{
